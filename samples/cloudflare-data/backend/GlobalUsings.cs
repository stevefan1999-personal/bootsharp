...
// The Minimal API surface. Global rather than per-file because every file in this
// sample is written against it — the same usings a `dotnet new web` Program.cs gets implicitly
// from the Web SDK, which a browser-wasm project does not use.
...
global using WorkerContext = Bootsharp.Cloudflare.WorkerContext<Cloudflare.Data.ICloudflareEnv>;
