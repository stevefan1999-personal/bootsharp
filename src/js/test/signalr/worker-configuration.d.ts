/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0a48157bf710b5a41cfe14d4c34ad0bb)
// Runtime types generated with workerd@1.20260811.1 2026-08-13 nodejs_compat
interface __BaseEnv_Env {
	ENVIRONMENT: "test";
	CHAT: DurableObjectNamespace<import("./worker/harness").ChatRoomHub>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/harness");
		durableNamespaces: "ChatRoomHub";
	}
