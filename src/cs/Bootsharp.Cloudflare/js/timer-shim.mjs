// Timer pump for the.NET runtime inside workerd. Ships in the package rather than per sample
//the hazard it guards against is workerd cancelling timers scheduled inside an
// I/O context when that context ends — one dropped tick latches.NET's scheduler and freezes the
// isolate for good — which is a property of the platform, not of any one app.
...
const delegateZeroDelay = globalThis.__bootsharpDelegateZeroDelayTimers === true;
