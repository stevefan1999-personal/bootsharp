    ...
    : DocumentClassifierPassBase
{
        ...
        MethodDeclarationIntermediateNode method)
    {
        ...
        // Generated files carry // <auto-generated/>, which turns the consumer's <Nullable>enable
        // off. A page that writes @param string? or @model Foo? would then be CS8669 in a file the
        // author never wrote. The writer already terminates this node, so the token is the pragma.
        @namespace.Children.Insert(0, NullableEnable());
        @namespace.Children.Insert(1, new UsingDirectiveIntermediateNode { Content = htmlNamespace });
    ...
    private static CSharpCodeIntermediateNode NullableEnable () => new() {
        Children = {
            new IntermediateToken { Kind = TokenKind.CSharp, Content = "#nullable enable" }
        }
    };
