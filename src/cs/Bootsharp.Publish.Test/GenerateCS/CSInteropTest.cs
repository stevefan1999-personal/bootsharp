...
public class CSInteropTest : GenerateCSTest
{
    ...
    public void GeneratesForMethodsInModules ()
    {
        AddAssembly(With(
            ...
            """));
        Execute();
        Contains("[JSExport] [return: JSMarshalAs<JSType.BigInt>] internal static long JS_Export_Space_IExported_Inv (global::System.String str, [JSMarshalAs<JSType.BigInt>] long info) => Serializer.Serialize(global::Bootsharp.Generated.JS_Export_Space_IExported.Inv(str, Serializer.Deserialize(info, SerializerContext.Space_Info)), SerializerContext.Space_Info);");
        Contains("""[JSImport("IImported.funSerialized", "space")] [return: JSMarshalAs<JSType.BigInt>] internal static partial long JS_Import_Space_IImported_Fun_Serialized (global::System.String str, [JSMarshalAs<JSType.BigInt>] long info);""");
        Contains("public static global::Space.Info JS_Import_Space_IImported_Fun (global::System.String str, global::Space.Info info) => Serializer.Deserialize(JS_Import_Space_IImported_Fun_Serialized(str, Serializer.Serialize(info, SerializerContext.Space_Info)), SerializerContext.Space_Info);");
    }
    ...
    public void GeneratesForMethodsInInstanced ()
    {
        AddAssembly(With(
            ...
            """));
        Execute();
        Contains("[JSExport] [return: JSMarshalAs<JSType.BigInt>] internal static long JS_Export_IExported_Inv (int _id, int it, [JSMarshalAs<JSType.BigInt>] long info) => Serializer.Serialize(Instances.Exported<global::IExported>(_id).Inv(Instances.Resolve<global::IExported>(it), Serializer.Deserialize(info, SerializerContext.Info)), SerializerContext.Info);");
        Contains("""[JSImport("IImported.funSerialized", "index")] [return: JSMarshalAs<JSType.BigInt>] internal static partial long JS_Import_IImported_Fun_Serialized (int _id, int it, [JSMarshalAs<JSType.BigInt>] long info);""");
        Contains("public static global::Info JS_Import_IImported_Fun (int _id, global::IImported it, global::Info info) => Serializer.Deserialize(JS_Import_IImported_Fun_Serialized(_id, Instances.Export(it), Serializer.Serialize(info, SerializerContext.Info)), SerializerContext.Info);");
        Contains("[JSExport] internal static async global::System.Threading.Tasks.Task<int> Class_GetExported (int it) => Instances.Export(await global::Class.GetExported(Instances.Resolve<global::IImported>(it)));");
        Contains("""[JSImport("Class.getImportedSerialized", "index")] internal static partial global::System.Threading.Tasks.Task<int> Class_GetImported_Serialized (int it);""");
    }
    ...
    public void GeneratesForPropertiesInModules ()
    {
        AddAssembly(With(
            ...
            """));
        Execute();
        Contains("[JSExport] [return: JSMarshalAs<JSType.BigInt>] internal static long JS_Export_Space_IExported_GetState () => Serializer.Serialize(global::Bootsharp.Generated.JS_Export_Space_IExported.GetState(), SerializerContext.Space_Info);");
        Contains("[JSExport] internal static void JS_Export_Space_IExported_SetState ([JSMarshalAs<JSType.BigInt>] long value) => global::Bootsharp.Generated.JS_Export_Space_IExported.SetState(Serializer.Deserialize(value, SerializerContext.Space_Info));");
        Contains("""[JSImport("IImported.getStateSerialized", "space")] [return: JSMarshalAs<JSType.BigInt>] internal static partial long JS_Import_Space_IImported_GetState_Serialized ();""");
        Contains("public static global::Space.Info JS_Import_Space_IImported_GetState() => Serializer.Deserialize(JS_Import_Space_IImported_GetState_Serialized(), SerializerContext.Space_Info);");
        Contains("""[JSImport("IImported.setStateSerialized", "space")] internal static partial void JS_Import_Space_IImported_SetState_Serialized ([JSMarshalAs<JSType.BigInt>] long value);""");
        Contains("public static void JS_Import_Space_IImported_SetState(global::Space.Info value) => JS_Import_Space_IImported_SetState_Serialized(Serializer.Serialize(value, SerializerContext.Space_Info));");
        Contains("[JSExport] internal static global::System.Boolean JS_Export_Space_IExported_GetActive () => global::Bootsharp.Generated.JS_Export_Space_IExported.GetActive();");
        Contains("""[JSImport("IImported.getActiveSerialized", "space")] internal static partial global::System.Boolean JS_Import_Space_IImported_GetActive_Serialized ();""");
        Contains("public static global::System.Boolean JS_Import_Space_IImported_GetActive() => JS_Import_Space_IImported_GetActive_Serialized();");
        Contains("[JSExport] internal static void JS_Export_Space_IExported_SetCount (global::System.Int32 value) => global::Bootsharp.Generated.JS_Export_Space_IExported.SetCount(value);");
        Contains("""[JSImport("IImported.setCountSerialized", "space")] internal static partial void JS_Import_Space_IImported_SetCount_Serialized (global::System.Int32 value);""");
        Contains("public static void JS_Import_Space_IImported_SetCount(global::System.Int32 value) => JS_Import_Space_IImported_SetCount_Serialized(value);");
    }
    ...
    public void GeneratesForPropertiesInInstanced ()
    {
        AddAssembly(With(
            ...
            """));
        Execute();
        Contains("[JSExport] [return: JSMarshalAs<JSType.BigInt>] internal static long JS_Export_IExported_GetState (int _id) => Serializer.Serialize(Instances.Exported<global::IExported>(_id).State, SerializerContext.Info);");
        Contains("[JSExport] internal static void JS_Export_IExported_SetState (int _id, [JSMarshalAs<JSType.BigInt>] long value) => Instances.Exported<global::IExported>(_id).State = Serializer.Deserialize(value, SerializerContext.Info);");
        Contains("""[JSImport("IImported.getStateSerialized", "index")] [return: JSMarshalAs<JSType.BigInt>] internal static partial long JS_Import_IImported_GetState_Serialized (int _id);""");
        Contains("[JSExport] internal static int JS_Export_IExported_GetExported (int _id) => Instances.Export(Instances.Exported<global::IExported>(_id).Exported);");
        Contains("[JSExport] internal static void JS_Export_IExported_SetImported (int _id, int value) => Instances.Exported<global::IExported>(_id).Imported = Instances.Resolve<global::IImported>(value);");
        Contains("""[JSImport("IImported.getImportedSerialized", "index")] internal static partial int JS_Import_IImported_GetImported_Serialized (int _id);""");
        Contains("public static global::IImported JS_Import_IImported_GetImported(int _id) => Instances.Resolve<global::IImported>(JS_Import_IImported_GetImported_Serialized(_id));");
        Contains("""[JSImport("IImported.setExportedSerialized", "index")] internal static partial void JS_Import_IImported_SetExported_Serialized (int _id, int value);""");
        Contains("public static void JS_Import_IImported_SetExported(int _id, global::IExported value) => JS_Import_IImported_SetExported_Serialized(_id, Instances.Export(value));");
    }
    ...
    public void GeneratesForEventsInModules ()
    {
        ...
        Contains(
            """
                ...
                internal static unsafe void Initialize ()
                {
                    global::Bootsharp.Generated.JS_Export_Space_IExported.Evt += Handle_JS_Export_Space_IExported_Evt;
                }
            """);
        Contains("void Handle_JS_Export_Space_IExported_Evt (global::Space.Info obj) => JS_Export_Space_IExported_BroadcastEvt_Serialized(Serializer.Serialize(obj, SerializerContext.Space_Info));");
        Contains("""[JSImport("IExported.broadcastEvtSerialized", "space")] internal static partial void JS_Export_Space_IExported_BroadcastEvt_Serialized ([JSMarshalAs<JSType.BigInt>] long obj);""");
        Contains("[JSExport] internal static void JS_Import_Space_IImported_InvokeEvt ([JSMarshalAs<JSType.BigInt>] long obj) => ((global::Bootsharp.Generated.JS_Import_Space_IImported)Modules.Imports[typeof(global::Space.IImported)].Instance).InvokeEvt(Serializer.Deserialize(obj, SerializerContext.Space_Info));");
    }
    ...
    public void DoesNotSerializeTypesThatShouldNotBeSerialized ()
    {
        ...
        Contains("""[JSImport("Class.funSerialized", "space")] internal static partial global::System.Threading.Tasks.Task<global::System.Exception> Space_Class_Fun_Serialized (global::System.Boolean a1, global::System.Byte a2, global::System.Char a3, global::System.Int16 a4, [JSMarshalAs<JSType.BigInt>] global::System.Int64 a5, global::System.Int32 a6, global::System.Single a7, global::System.Double a8, global::System.IntPtr a9, [JSMarshalAs<JSType.Date>] global::System.DateTime a10, [JSMarshalAs<JSType.Date>] global::System.DateTimeOffset a11, global::System.String a12);""");
        ...
        Contains("""[JSImport("Class.funNullSerialized", "space")] [return: JSMarshalAs<JSType.Promise<JSType.Date>>] internal static partial global::System.Threading.Tasks.Task<global::System.DateTime> Space_Class_FunNull_Serialized (global::System.Boolean? a1, global::System.Byte? a2, global::System.Char? a3, global::System.Int16? a4, [JSMarshalAs<JSType.BigInt>] global::System.Int64? a5, global::System.Int32? a6, global::System.Single? a7, global::System.Double? a8, global::System.IntPtr? a9, [JSMarshalAs<JSType.Date>] global::System.DateTime? a10, [JSMarshalAs<JSType.Date>] global::System.DateTimeOffset? a11, global::System.String? a12);""");
        Contains("public static global::System.Threading.Tasks.Task<global::System.DateTime> Space_Class_FunNull (global::System.Boolean? a1, global::System.Byte? a2, global::System.Char? a3, global::System.Int16? a4, global::System.Int64? a5, global::System.Int32? a6, global::System.Single? a7, global::System.Double? a8, global::System.IntPtr? a9, global::System.DateTime? a10, global::System.DateTimeOffset? a11, global::System.String? a12) => Space_Class_FunNull_Serialized(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12);");
    }
    ...
    public void SerializesTypesThatShouldBeSerialized ()
    {
        ...
        Contains("[JSExport] [return: JSMarshalAs<JSType.Promise<JSType.BigInt>>] internal static async global::System.Threading.Tasks.Task<long> Space_Class_InvB ([JSMarshalAs<JSType.BigInt>] long a) => Serializer.Serialize(await global::Space.Class.InvB(Serializer.Deserialize(a, SerializerContext.Space_RecordArray)), SerializerContext.Space_RecordArray);");
    ...
    public void RespectsPref ()
    {
        ...
        Contains("""[JSImport("IImported.funSerialized", "foo")] internal static partial void JS_Import_Space_IImported_Fun_Serialized ();""");
