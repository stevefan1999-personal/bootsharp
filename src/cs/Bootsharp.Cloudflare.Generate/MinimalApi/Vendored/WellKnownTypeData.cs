...
//   upstream: src/Shared/RoslynUtils/WellKnownTypeData.cs
//   commit:   80de79ab881ab6b3899146db6c6fb8f8d339fd94
//   local changes: none — copied verbatim. Entries naming types this
//     compilation does not have are resolved lazily and never asked for, so the table stays
//     whole rather than being trimmed to a subset that would drift on every upstream bump.
...
internal static class WellKnownTypeData
{
    public enum WellKnownType
    {
        ...
        System_ComponentModel_DisplayNameAttribute,
