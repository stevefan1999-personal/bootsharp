...
// upstream: src/Shared/RoslynUtils/ParsabilityHelper.cs
// commit: 80de79ab881ab6b3899146db6c6fb8f8d339fd94
// local changes: none — copied verbatim. Only the parsability half is called:
// it encodes the IParsable<T> / TryParse(string, IFormatProvider, out T) / TryParse(string,
// out T) / enum / Uri ladder binds parameters with. The bindability half stays
// uncalled by design — BindAsync is not in this package's binding ladder, and its well-known
// lookups (IBindableFromHttpContext<T>) name types the vendored runtime does not declare.
