// API-identical reimplementation of Microsoft.AspNetCore.SignalR.HubCallerContext (MIT,.NET
// Foundation). Upstream: src/SignalR/server/Core/src/HubCallerContext.cs — seven abstract members,
// copied verbatim including Features, whose IFeatureCollection comes from the real
// Microsoft.Extensions.Features package, not from a vendored copy.
...
public abstract class HubCallerContext
{
    ...
    /// <summary>Gets the collection of HTTP features available on the connection.</summary>
